...
public class TMDBMappingService : IDataMappingService
{
    ...
    {
        var posterPath = $"{_appSettings.TMDBSettings.BaseImagePath}/{_appSettings.CinemaProSettings.DefaultPosterSize}/{path}";
    ...
    private string BuildCastImage(string profilePath)
    {
        if (string.IsNullOrEmpty(profilePath))
            return _appSettings.CinemaProSettings.DefaultCastImage;

        return $"{_appSettings.TMDBSettings.BaseImagePath}/{_appSettings.CinemaProSettings.DefaultPosterSize}/{profilePath}";
    }
